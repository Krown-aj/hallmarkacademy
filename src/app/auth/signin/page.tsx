...
const SignIn = () => {
    ...
    const fillDemoCredentials = (role: string) => {
        const demoCredentials = {
            admin: { email: "admin@hallmarkacademy.ng", password: "admin123" },
            teacher: { email: "teacher@hallmarkacademy.ng", password: "teacher123" },
            student: { email: "student@hallmarkacademy.ng", password: "student123" },
            parent: { email: "parent@hallmarkacademy.ng", password: "parent123" },
        };
                        ...
                        <Card className="p-8 shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <Button
                                    ...
                                    className="w-full p-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 border-0 rounded-lg font-semibold text-white transition-all duration-300"
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {[
                                    { role: "admin", label: "Admin", color: "from-purple-500 to-purple-600" },
                                    { role: "teacher", label: "Teacher", color: "from-green-500 to-green-600" },
                                    { role: "student", label: "Student", color: "from-blue-500 to-blue-600" },
                                    { role: "parent", label: "Parent", color: "from-orange-500 to-orange-600" },
                                ].map((demo) => (
                                    <Button
                                        key={demo.role}
                                        label={demo.label}
                                        size="small"
                                        className={`p-2 bg-gradient-to-r ${demo.color} border-0 text-white text-xs`}
