...
const News: React.FC = () => {
    ...
    return (
        <section className="py-20 bg-gradient-to-b from-blue-50 via-white to-gray-900 relative overflow-hidden">
            {/* Background Elements */}
                    ...
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                            <input
                                ...
                                className="flex-1 px-6 py-4 rounded-full text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-blue-300"
                            />
                            <motion.button
